...
public:
    static void OnActivityJoin(void* callbackData, char const* secret)
    {
        ...
        auto& _module = core->ActivityManager();
        _module.OnActivityJoin(static_cast<const char*>(secret));
    }
    ...
    static void OnActivitySpectate(void* callbackData, char const* secret)
    {
        ...
        auto& _module = core->ActivityManager();
        _module.OnActivitySpectate(static_cast<const char*>(secret));
    }
    ...
    static void OnActivityJoinRequest(void* callbackData, DiscordUser* user)
    {
        ...
        auto& _module = core->ActivityManager();
        _module.OnActivityJoinRequest(*reinterpret_cast<User const*>(user));
    }
                                 ...
                                 DiscordActivity* activity)
    {
        ...
        auto& _module = core->ActivityManager();
        _module.OnActivityInvite(static_cast<ActivityActionType>(type),
