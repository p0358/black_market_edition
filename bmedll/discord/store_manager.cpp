...
public:
    static void OnEntitlementCreate(void* callbackData, DiscordEntitlement* entitlement)
    {
        ...
        auto& _module = core->StoreManager();
        _module.OnEntitlementCreate(*reinterpret_cast<Entitlement const*>(entitlement));
    }
    ...
    static void OnEntitlementDelete(void* callbackData, DiscordEntitlement* entitlement)
    {
        ...
        auto& _module = core->StoreManager();
        _module.OnEntitlementDelete(*reinterpret_cast<Entitlement const*>(entitlement));
    }
};
