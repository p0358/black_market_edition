...
// =====================================================================================================================
//    $Rev: 140 $  $Id: dwinshs.iss 140 2019-10-24 17:33:32Z hanjy $
// =====================================================================================================================
...
const
  ...
  HTTP_QUERY_STATUS_CODE = 19;
    ...
    #define DwinsHs_Data_Buffer_Length 65535
  #endif
...
#ifdef DwinsHs_Separate_Retry_Button
function CreateButton(OwnerControl: TComponent; Caption: string;
  Left, Top, Width: Integer): TButton;
begin
  Result := TButton.Create(OwnerControl);
  if OwnerControl = WizardForm then
    Result.Parent := WizardForm
  else
    Result.Parent := TWizardPage(OwnerControl).Surface;
  ...
  Result.Top := Top;
  Result.Width := Width;
  Result.Height := WizardForm.CancelButton.Height;
end;
#endif
...
#if (Find(FindSection('Files') , 'DwinsHs_Check(', FIND_CONTAINS||FIND_TRIM) > 0)
...
#ifdef DwinsHs_Separate_Retry_Button
procedure DwinsHs_RetryButtonClick(Sender: TObject); forward;
#endif
...
begin
  ...
  DwinsHs_DownloadWizardDefine.TotalProgress.Anchors := [akTop, akLeft, akRight];
  #endif
  ...
  DwinsHs_DownloadWizardDefine.TotalProgressBar := CreateProgressBar(DwinsHs_DownloadWizardDefine.DownloadingPage,
    ...
    0);
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.TotalProgressBar.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.CurrentProgress.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  DwinsHs_DownloadWizardDefine.CurrentProgressBar := CreateProgressBar(DwinsHs_DownloadWizardDefine.DownloadingPage,
    ...
    0);
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.CurrentProgressBar.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.DownloadFile.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.DownloadSpeed.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.DownloadStatus.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.DownloadElapsedTime.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #if Ver > EncodeVer(6, 0, 0)
  DwinsHs_DownloadWizardDefine.DownloadRemainingTime.Anchors := [akLeft, akTop, akRight];
  #endif
  ...
  #ifdef DwinsHs_Separate_Retry_Button
  DwinsHs_DownloadWizardDefine.RetryButton := CreateButton(WizardForm,
    ExpandConstant('{cm:DwinsHs_Status_ButtonRetry}'), ScaleX(10), WizardForm.NextButton.Top,
    WizardForm.NextButton.Width);
  DwinsHs_DownloadWizardDefine.RetryButton.OnClick := @DwinsHs_RetryButtonClick;
  DwinsHs_DownloadWizardDefine.RetryButton.Visible := False;
  #endif
...
#ifdef DwinsHs_Use_MemoDownloadInfo
...
begin
  ...
  begin
    ...
    begin
        ...
        begin
          Result := Result + Space + ExpandConstant('{cm:DwinsHs_ReadyMemo_Downloaded}');
        end;
  ...
  if Result <> '' then
  begin
    Result := ExpandConstant('{cm:DwinsHs_ReadyMemo_Download}') + NewLine + Result;
  end;
end;
#endif
...
begin
  ...
  begin
    #ifdef DwinsHs_Separate_Retry_Button
    DwinsHs_DownloadWizardDefine.RetryButton.Visible := True;
    DwinsHs_DownloadWizardDefine.RetryButton.Enabled := False;
    DwinsHs_DownloadWizardDefine.RetryButton.Repaint;
    #else
    ...
    case DwinsHs_CancelDownload of
      cdNone:
      begin
        #ifndef DwinsHs_Separate_Retry_Button
        WizardForm.NextButton.Enabled := True;
        #endif
        if State <> READ_OK then
        begin
          #ifdef DwinsHs_Separate_Retry_Button
          DwinsHs_DownloadWizardDefine.RetryButton.Enabled := True;
          DwinsHs_DownloadWizardDefine.RetryButton.Repaint;
          #endif
...
#ifdef DwinsHs_Separate_Retry_Button
procedure DwinsHs_RetryButtonClick(Sender: TObject);
begin
  if DwinsHs_DownloadWizardDefine.DownloadError then
  begin
    DwinsHs_CurPageChanged(DwinsHs_DownloadWizardDefine.DownloadingPage.Id, DwinsHs_BeforeDownload,
      DwinsHs_AfterDownload);
  end;
end;
#endif
